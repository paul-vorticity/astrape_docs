...
<Steps>
  ...
  <Step title="Postprocessing">
    ...
    <Warning> For the postprocessing step, the path should be the path to the experiment folder, not the survey folder. The experiment folder is created during the inversion process and is a timestamped subfolder within the `inversion` folder.</Warning>
  </Step>
</Steps>
