...
## Example Inversion Configuration File:
...
## Key Components of the Inversion Configuration File
...
<AccordionGroup>
  ...
  Whether to use topography in the inversion. If True, the earth is not approximated to have a flat surface at z=0. Data Type: Boolean.
  </Accordion>  
  ...
  The number of GPUs to use for the inversion when the schedule strategy is set to "fixed". Data Type: Positive Integer.
  </Accordion>  
</AccordionGroup>
...
<AccordionGroup>
  ...
  The scale of the initial model. Options: "linear", "log". Data Type: String.
  </Accordion>
</AccordionGroup>
