...
A default configuration file will be generated during the preprocessing step. The inversion provided in the default configuration file is based upon the provided data and other parameters provided in the system configuration file. After the preprocessing step, the user can modify the configuration file to adjust the inversion parameters as they see fit.
