...
<AccordionGroup>
  <Accordion icon="github" title="Logo File (logo_file)">
...
<Accordion icon="github" title="Data Epsilon (data_eps)">
...
<AccordionGroup>
<Accordion icon="github" title="Type (type)">
The type of waveform used. Valid options are:
* "VTEM"
* "XCite"
</Accordion>
<Accordion icon="github" title="Filepath (filepath)">
...
<Accordion icon="github" title="Discretization (discretization)">
