...
<Accordion icon="rectangle-terminal" title="Loop Terrain Clearance (zcol)">
...
<AccordionGroup>
<Accordion icon="rectangle-terminal" title="Waveform Type (type)">
The type of waveform used. Valid options are:
* "VTEM"
* "XCite"
</Accordion>
<Accordion icon="rectangle-terminal" title="Current Column Name (current_col)">
The name of the column within the data file that provides the current waveform data. Data Type: String.
</Accordion>
<Accordion icon="rectangle-terminal" title="Time Column Name (time_col)">
...
<Accordion icon="rectangle-terminal" title="File Start Index (file_start_index)">
The index of the first data point in the data file. Data Type: Positive Integer.
</Accordion>
<Accordion icon="rectangle-terminal" title="Sampling Column Name (sampling_col_name)">
