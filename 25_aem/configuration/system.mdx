...
Please see the following example configuration file: 

<Accordion title="Example System Configuration File:">
  ```yaml System Configuration Example
  deliverables: 
  logo_file: "logo.png"
  area_name: "Batchawana Property"
  project_id: "Project_9012"
...
receiver: 
  data_tc_end: 33
  data_tc_start: 10
  sampling_filepath: "sterling_offtime_sampling.csv"
  file_start_index: 0
  time_scale_s: 1.0e-3
  ```
</Accordion>
