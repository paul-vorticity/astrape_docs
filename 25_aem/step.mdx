...
<Steps>
  ...
  <Step title="Preprocessing ">
    The preprocessing setup performs many crucial functions for the inversion process, including system configuration validation, default configuration files generation and data validation/preparation. The preprocessing can be done with the following command:
    ```
  ...
  <Step title="Run Inversion">
    Now we are ready to run the inversion! This can be done with the following command: 
    ```
    ...
    After the inversion has been completed, you can perform postprocessing to generate the final deliverables. This can be done with the following command: 
    ```
    ...
    Once the postprocessing has been completed, you can view the outputs in the `deliverables` folder. This folder contains all the final results, including reports and visualizations.
