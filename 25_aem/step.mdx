...
<Steps>
  ...
  <Step title="Perform Preprocessing ">
    ...
    ```
    astrape.exe preprocess /home/path_to_survey_folder
    ```
  ...
  <Step title="Run Inversion">
    ...
    This can be done with the following command: 
    ```
    astrape.exe run /home/path_to_survey_folder
    ```
    <Info>
    ...
    <Step title="Perform Postprocessing">
    After the inversion has been completed, you can perform postprocessing to analyze the results.

    This can be done with the following command: 
    ```
    astrape.exe postprocess /home/path_to_survey_folder name_of_run_subfolder
    ```
    <Info>
