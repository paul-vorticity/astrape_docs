...
2.5D inversion of Airborn Electromagnetic data is a geophysical data processing technique that combines the simplicity of 2D inversion with some aspects of 3D inversion.
...
Sure, here's a markdown file that describes the overall folder structure and a suggested name for the super folder: