...
<Tabs>
  <Tab title="astrape_inversion_data.csv">
  ...
  <Tab title="astrape_inversion_extended_data.csv">
  ...
  <Tab title="astrape_inversion_extended_data.xyz">
    Contains the same data as `astrape_inversion_extended_data.csv` but in XYZ format.
  </Tab>
</Tabs>