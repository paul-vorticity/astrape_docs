...
Once the Ray cluster has been started, the distribution and scaling of the inversion process will be handled automatically by the Astrape code in a way that is most efficient for the cluster.
