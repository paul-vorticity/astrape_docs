...
This script processes the data after the inversion has been performed. It interpolates, filters, and prepares the inversion data for further analysis.
...
```bash
python postprocess.py <exp_path> <dim> [options]
```
...
```bash
python postprocess.py /path/to/inversion_data 3d --sigma_min 0.1 --sigma_max 1.5
```

This command will process the inversion data for a 3D survey and apply sigma filtering between 0.1 and 1.5.
```
